    ...
    <>
      ...
      >
        <div className="container flex gap-8 flex-col xl:flex-row relative">
          ...
          {/* This div will only show on extra large devices (xl and above) */}
          <div className="absolute -bottom-12 left-72 h-[590px] w-[610px] border rounded-2xl dark:bg-gray-dark bg-white border-primary  mx-auto hidden lg:block"></div>
        </div>
      </section>
