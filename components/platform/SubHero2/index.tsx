        ...
        <div className="container flex flex-col-reverse lg:flex-row lg:gap-24">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-xl leading-relaxed py-7 dark:text-gray-400">
              <strong className="text-white">EntroMetrix improves energy and resource efficiency</strong> to reduce Scope 1 and 2 emissions by cutting waste and optimizing equipment performance, while supporting Scope 3 reductions through leaner, more efficient supply chain operations.
            </p>
          </div>
        </div>
      </section>
